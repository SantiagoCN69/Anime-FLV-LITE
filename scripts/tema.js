...
(() => {
    const themes = {
        ...
        verde: {p: '#18221C',b: '#0F1612',t1: '#E5FFE5',t2: '#A3B9A3',br: '#2F3F34',btn: '#00FF99',f: 1,bgt: '255, 255, 255'},
        neon: {p: '#1F1F2E',b: '#141422',t1: '#FFFFFF',t2: '#ddd',br: '#3A3A4A',btn: '#CEA5FF',f: 1,bgt: '255, 255, 255'},
        light: {p: '#FAFAFA', b: '#F0F0F0', t1: '#111', t2: '#222', br: '#ccc', btn: '#FF3B3B', f: 2, bgt: '0, 0, 0'},
    };
