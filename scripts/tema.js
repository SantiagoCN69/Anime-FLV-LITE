...
(() => {
    const themes = {
        ...
        verde: {p: '#18221C',b: '#0F1612',t1: '#E5FFE5',t2: '#A3B9A3',br: '#3C5143',btn: '#00FF99',f: 1,bgt: '255, 255, 255'},
        neon: {p: '#1F1F2E',b: '#141422',t1: '#FFFFFF',t2: '#ddd',br: '#4A3A6A',btn: '#CEA5FF',f: 1,bgt: '255, 255, 255'},
